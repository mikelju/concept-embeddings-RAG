...
| 11 | A better use of the entities at FullWiki scale (step 2 of 2) | [Approved](phase_11/11.spec.md) | **In progress** — [plan](phase_11/11.0_entity_use.md) |
